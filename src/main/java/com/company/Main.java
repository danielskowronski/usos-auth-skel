...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            //chyba między sesjami trzeba trzymać ciasteczko JSESSIONID=125B9DBD28C85F1042952AA295E68EAD
            HttpPost httpPost = new HttpPost(URL_LOGIN);
            String postparams = "username=daniel.skowronski@student.uj.edu.pl&password=XD&lt="+jakis_token+"&_eventId=submit&submit=zaloguj";
